...
const CooperativeHeader = () => {
  ...
  const company = { id: '2', name: 'Elicom Coopérative', slug: 'cooperative', primaryColor: '#166534' };
    ...
    >
      <nav className="w-full max-w-7xl mx-auto flex justify-between items-center px-4 text-white">
        <Link to="/" className="flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
          ...
          <span className="font-bold text-lg">ELICOM COOPÉRATIVE</span>
        </Link>
              ...
              {companyMenus.map(menu => (
                <Link
                  ...
                  className={twMerge(
                    ...
                    location.pathname === menu.path
                      ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300 font-semibold'
