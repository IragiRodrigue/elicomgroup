...
const ImprimerieHeader = () => {
  ...
  const company = { id: '1', name: 'Elicom Imprimerie', slug: 'imprimerie', primaryColor: '#1e3a8a' };
    ...
    >
      <nav className="w-full max-w-7xl mx-auto flex justify-between items-center px-4 text-white">
        <Link to="/" className="flex items-center gap-2" onClick={() => setIsMobileMenuOpen(false)}>
          ...
          <span className="font-bold text-lg">ELICOM IMPRIMERIE</span>
        </Link>
...
export default ImprimerieHeader;